...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        def conv_lrelu(in_channels, out_channels, ksize, stride, pad):
        ...
        self.block1 = nn.Sequential(
            conv_lrelu(3, 64, 3, 1, 1),
            conv_lrelu(64, 64, 3, 1, 1),
            nn.AvgPool2d(2, 2),
            conv_lrelu(64, 128, 3, 1, 1),
            conv_lrelu(128, 128, 3, 1, 1),
            nn.AvgPool2d(2, 2),
            conv_lrelu(128, 256, 3, 1, 1),
            conv_lrelu(256, 256, 3, 1, 1),
            nn.AvgPool2d(2, 2)
        )
        self.block2 = nn.Sequential(
            conv_lrelu(256, 512, 3, 1, 1),
            conv_lrelu(512, 512, 3, 1, 1),
            nn.AvgPool2d(2, 2)
        )
