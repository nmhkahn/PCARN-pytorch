...
class Net(nn.Module):
    def __init__(self, scale=2, multi_scale=True, group=1):
        ...
        self.up2 = nn.ConvTranspose2d(56, 1, 9, 2, 4, output_padding=1)
        self.up3 = nn.ConvTranspose2d(56, 1, 9, 3, 4, output_padding=2)
        self.up4 = nn.ConvTranspose2d(56, 1, 9, 4, 4, output_padding=3)
